package ua.khpi.oop.lunhol16.Head;
...
public class HDR1 implements Serializable {
    ...
    public static final Comparator<HDR1> compareByPassport =Comparator.comparingLong(HDR1::getNumberPassport);
    public static final Comparator<HDR1> compareByPayment = Comparator.comparingInt(HDR1::getPayment);
    public static final Comparator<HDR1> compareByMarks = Comparator.comparingInt(HDR1::getMarks);
